...
type_I_err <- check_results$metrics |>
  ...
  labs(x = "Sparsity of X|Z model",
       y = "Type I Error") +
  theme(legend.position = "bottom") 


ggsave(filename = "varying-X|Z-sparsity-gaussian-binomial.png",
       plot = type_I_err,
       device = "png",
       width = 5,
       height = 5)
...
saveRDS(check_results, 
        "~/Dropbox (Penn)/CRT-revision/symcrt-revision/code/result/Q2_varying_X|Z_sparsity.rds")
