...
\begin{frontmatter}
	\title{{Supplementary Materials for: \\ ``Reconciling model-X and doubly robust approaches\\ 
	to conditional independence testing"}}
	\runtitle{reconciliation of model-X and doubly robust testing approaches}
