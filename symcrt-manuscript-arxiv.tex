...
\begin{document}
	...
	\end{equation}
	at level $\alpha \in (0,1)$ using $n$ data points\footnote{We use boldface font to denote population quantities and regular font to denote sample quantities.}
	\begin{equation}
		\label{eq:xyz}
